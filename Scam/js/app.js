...
const AppController = (() => {
  ...
  function renderGauge(score) {
    ...
    const color = score >= 55 ? '#f44336' : score >= 25 ? '#ff9800' : '#00e676';
      ...
      <div class="gauge-wrapper">
        <svg viewBox="0 0 180 100" class="gauge-svg">
          ...
          <path d="M 18 90 A ${R} ${R} 0 0 1 162 90"
                stroke="#1a1a3a" stroke-width="14" fill="none" stroke-linecap="round"/>
          ...
          <text x="90" y="94" text-anchor="middle" class="gauge-unit" fill="#7070a0">/ 100</text>
        </svg>
      </div>`;
  }
